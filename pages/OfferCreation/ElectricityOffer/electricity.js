...
export class Electricityjourney {
    ...
    constructor(page) {
        ...
        this.home_onePerson_Selection_KWH = page.locator('//div[@class="ShortFormPlain_radioButton__Cf3Je theme-color-primary"]//div');
    ...
    async gotoremindme(){
        ...
        // Function to accept cookies
            ...
            await acceptCookiesButton.click();
             ...
             //await page.click('(//button[text()="Alle Akzeptieren"])');
        
    }
    async  clickonElectricityButton(){
        await this.home_electricity.isVisible();
        await this.home_electricity.click();
    }
    ...
    async  clickonCheckSavingButton(){
        await this.home_checksavingbutton.click();
    }
